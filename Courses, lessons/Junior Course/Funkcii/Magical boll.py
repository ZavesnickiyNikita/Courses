...
print(f'Привет, {name}')
while True:
    questions = input('Задай свой вопрос магическому шару!)')
    print(random.choice(answers))
    questions2 = input('Хочешь ли ты задать еще вопрос магическому шару?').lower()
    if questions2 == 'да':
        continue
    else:
        print(f'Всего доброго {name}. Если будут еще вопросы ты знаешь, где меня найти.')
        break